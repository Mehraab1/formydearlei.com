              ...
              <AnimatePresence>
                {showSurprise && (
                  ...
                  >
                    ...
                    >
                      This flower is a small sign of care...🌹
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      I really value the connection we’re building. I promise to be more mindful, to respect you, and never take your kindness for granted again.💖
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
